...
import SafePlaceLogo from './SafePlaceLogo';

const SensibilisationPage = ({ onClose }) => {
    ...
    const handlePressOut = () => {
        Animated.spring(scaleAnim, {
            ...
            friction: 3,
            useNativeDriver: true,
        }).start(onClose); // Appel de la fonction `onClose` après l'animation
    };
    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            ...
            <Animated.Text style={{ ...styles.message, opacity: fadeAnim }}>
                Protégez votre bien-être en ligne avec des outils conçus pour réduire les risques d'addiction et améliorer votre expérience.
            </Animated.Text>
